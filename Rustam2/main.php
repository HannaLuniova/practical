            ...
            <div class="registr__inner">
                <div class="registr__content">
                    <form class="registr__form" action="" method="$_POST">
                        ...
                        <input class="registr__input" type="text" name="" placeholder="Email" tabindex="1" autofocus>
                        <input class="registr__input" type="text" name="" placeholder="Password" tabindex="2">
