        ...
        <div class="container">
            <div class="footer__inner">
                <div class="footer__top">
                    <form class="footer__form" action="" method="$_POST">
                        <p class="footer__title">Войти под правами администратора</p>
                        <input class="footer__input" type="text" name="" placeholder="Email" autofocus>
                        <input class="footer__input" type="text" name="" placeholder="Password">
