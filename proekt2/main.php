            ...
            <div class="registr__inner">
                <div class="registr__content">
                    <form class="registr__form" action="">
                        ...
                        <input class="registr__form-input" type="text" name="" placeholder="Имя" tabindex="1" autofocus>
                        <input class="registr__form-input" type="text" name="" placeholder="Пароль" tabindex="2">
                        <button class="registr__form-btn" type="submit" tabindex="3">Регистрация</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <section class="about">
        <div class="container">
            <div class="about__inner">
                ...
                <form class="about__form" action="" method="$_POST">
                    <h3 class="about__title">Войти под правами администратора</h3>
                    <input class="about__form-input" type="text" name="" placeholder="Имя" tabindex="1" autofocus>
                    <input class="about__form-input" type="text" name="" placeholder="Пароль" tabindex="2">
                    <button class="about__form-btn" type="submit" tabindex="3">Войти</button>
                </form>
            </div>
        </div>
    </section>
