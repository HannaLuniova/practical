        ...
        <div class="container">
            <div class="inner__content">
                ...
                VALUES ('$q1', '$q2', '$q3', '$q4', '$q5')");
                    $mysql->close();
                    echo ' <p class="reg">Благодарим Вас за участие в опросе !!!</p>
                            <a class="link" href="main.php">Вернуться на главную страницу</a>';
                } else {
                    ...
                    if (
                        ...
                        echo "<p class='reg'>Выберите варианты ответа для всех вопросов</p> <br>
                              <a class='link' href='test.php'>Вернуться к опросу</a>";
                    };
                }
                ?>
            </div>
